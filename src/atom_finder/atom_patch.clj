...
(def test-res
'({:revstr "2f757f27149ab88581675cd33d232da75dbec603",
  :bug-ids #{},
  :files
  ({:file "gcc/config/rs6000/rs6000.c",
    :source-chars-before 1275876,
    :source-chars-after 1275608,
    :atoms
    ({:atom :preprocessor-in-statement,
      :stats {:atom-counts-before-after {:count-before 8, :count-after 8}}}
     {:atom :macro-operator-precedence,
      :stats {:atom-counts-before-after {:count-before 31, :count-after 31}}})}
   {:file "gcc/config/rs6000/t-rs6000",
    :source-chars-before 2458,
    :source-chars-after 2516,
    :atoms
    ({:atom :preprocessor-in-statement,
      :stats {:atom-counts-before-after {:count-before 0, :count-after 0}}}
     {:atom :macro-operator-precedence,
      :stats {:atom-counts-before-after {:count-before 0, :count-after 0}}})})}
 {:revstr "8ad677cc3cfde908135a443865d6301a1b3ae37f",
  :bug-ids #{},
  :files
  ({:file "gcc/testsuite/ChangeLog",
    :source-chars-before 538516,
    :source-chars-after 538661,
    :atoms
    ({:atom :preprocessor-in-statement,
      :stats {:atom-counts-before-after {:count-before 0, :count-after 0}}}
     {:atom :macro-operator-precedence,
      :stats {:atom-counts-before-after {:count-before 0, :count-after 0}}})}
   {:file "gcc/testsuite/gcc.target/powerpc/fold-vec-add-7.c",
    :source-chars-before 620,
    :source-chars-after 665,
    :atoms
    ({:atom :preprocessor-in-statement,
      :stats {:atom-counts-before-after {:count-before 0, :count-after 0}}}
     {:atom :macro-operator-precedence,
      :stats {:atom-counts-before-after
